...
const handleOnScroll = () => {
    ...
    const translateY = -scrollPosition * 3; // Adjust the multiplier for the desired parallax effect

    track.style.transform = `translate(-50%, ${translateY}px)`;

    for (const image of track.getElementsByClassName("image")) {
        const imageScrollPosition = (scrollPosition - image.offsetTop) * 3; // Adjust the multiplier for the desired parallax effect
